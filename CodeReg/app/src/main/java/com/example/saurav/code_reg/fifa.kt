...
import kotlinx.android.synthetic.main.activity_fifa.*

class fifa : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dsndbtn.setOnClickListener {
            if (Display.text!=null) {
                ...
                var mydatabase = FirebaseDatabase.getInstance().getReference("Lan-Gaming/Fifa")
