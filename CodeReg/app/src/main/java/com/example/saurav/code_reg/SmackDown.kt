...
import kotlinx.android.synthetic.main.activity_smack_down.*

class SmackDown  : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_smack_down)
        ...
        dsndbtn.setOnClickListener {
            if (Display.text!=null) {
                ...
                var mydatabase = FirebaseDatabase.getInstance().getReference("Lan-Gaming/Smack-Down")
