...
import kotlinx.android.synthetic.main.activity_dbugging.*

class dbugging : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_dbugging)
        ...
        dsndbtn.setOnClickListener {
            if (Display.text!=null) {
                ...
                var mydatabase = FirebaseDatabase.getInstance().getReference("D-BUGGING")
