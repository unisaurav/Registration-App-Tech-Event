...
import kotlinx.android.synthetic.main.activity_brain_teaser.*

class BrainTeaserAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dsndbtn.setOnClickListener {
            if (Display.text!=null) {
                ...
                var mydatabase = FirebaseDatabase.getInstance().getReference("BrainTeaser")
